# -*- coding: utf-8 -*-
"""Refined_ImageDivision_Without_TF_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nGH_B7W0cwc4K8Rx0REzrZCFoVdMAfWm
"""
...
def ImageDivision_DividedNetwork(Image):
  FirstPart, other1, rest1 = np.hsplit(Image, [24, 28])
  other2, SecondPart, rest2 = np.hsplit(Image, [12, 28])
  start_time = datetime.now()
  Part1 = ImageDivision_FirstFourLayers(FirstPart, 20, 10, 8)
  end_time = datetime.now()
  print('Part1 Duration (big 24/28): {}'.format(end_time - start_time))
  start_time = datetime.now()
  Part2 = ImageDivision_FirstFourLayers(SecondPart, 8, 4, 2)
  end_time = datetime.now()
  print('Part2 Duration (small 12/28): {}'.format(end_time - start_time))
  start_time= datetime.now()
  B4 =  np.array(np.concatenate((Part1 , Part2), axis=2))
  ...
  end_time = datetime.now()
  print('Duration of the rest : {}'.format(end_time - start_time))
  return result

def ImageDivision_NormalNetwork(Image):
...
start_time = datetime.now()
print("Normal Network", ImageDivision_NormalNetwork(Input_0))
end_time = datetime.now()
print('Normal Network Duration: {}'.format(end_time - start_time))

start_time = datetime.now()
print("Divided Network", ImageDivision_DividedNetwork(Input_0))
end_time = datetime.now()
