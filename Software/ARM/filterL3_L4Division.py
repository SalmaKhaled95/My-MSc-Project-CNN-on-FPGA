# -*- coding: utf-8 -*-
"""Refined_FilterDivision_L3+L4_Without_TF_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1pPQ20htKnRyse6XToNR-N9XB8lGXujUr
"""
...
start_time = datetime.now()
myfile = open("/content/input4.txt")
A= ArrayFromText (myfile)
...
def Conv2Layer_Without_TF_3(inputArray, ConvWeightsArray, ConvBiasArray, Axis1x, Axis2y):
  rearrangedinput = np.moveaxis(inputArray, [1,2,3],[3,1,2])
  rearrangedweights = np.moveaxis(ConvWeightsArray, [0,1,2,3],[2,3,0 ,1 ])
...
def Conv2Layer_Without_TF_1(inputArray, ConvWeightsArray, ConvBiasArray, Axis1x, Axis2y):
  rearrangedinput = np.moveaxis(inputArray, [1,2,3],[3,1,2])
  rearrangedweights = np.moveaxis(ConvWeightsArray, [0,1,2,3],[2,3,0 ,1 ])
...
def Division_FirstThreeFilters_L3_L4(feature2):
  featureMap3= Conv2Layer_Without_TF_3([feature2.reshape([4, 12, 12])], MOVEDONE , arrayfromTextCONVBias2, 12, 12)
  featureMap4=  Maxpool_Without_TF_3(featureMap3, 10, 10)
  return featureMap4

def Division_LastFilter_L3_L4(feature2):
  featureMap3= Conv2Layer_Without_TF_1([feature2.reshape([4, 12, 12])], MOVEDONE , arrayfromTextCONVBias2, 12, 12)
  featureMap4=  Maxpool_Without_TF_1(featureMap3, 10, 10)
  return featureMap4
...
def FilterDivision_L3_L4_DividedNetwork(Image):
  start_time = datetime.now()
  featureMap1 =  Conv1Layer_Without_TF (Image, arrayfromTextCONVWeight1, arrayfromTextCONVBIAS1  )
  featureMap2 = Maxpool_Without_TF (featureMap1, 24, 24)
  end_time = datetime.now()
  print('The First Rest Duration: {}'.format(end_time - start_time))
  
  
  start_time = datetime.now()
  Part1 = Division_FirstThreeFilters_L3_L4(featureMap2)
  end_time = datetime.now()
  print('Part1 Duration (first 3 filters) : {}'.format(end_time - start_time))


  start_time = datetime.now()
  Part2 = Division_LastFilter_L3_L4(featureMap2)
  end_time = datetime.now()
  print('Part2 Duration (last filter) : {}'.format(end_time - start_time))

  start_time = datetime.now()
  B4 =  np.array(np.concatenate((Part1 , Part2), axis=0))
  featureMap4new = FlattenLayer(B4 , 4, 25)
  ...
  end_time = datetime.now()
  print('The Second Rest Duration: {}'.format(end_time - start_time))
  return result
...
start_time = datetime.now()
print("Divided Network", FilterDivision_L3_L4_DividedNetwork(Input_0))
end_time = datetime.now()
